...
if (!dbExists) {
  db.exec(`
    ...
    VALUES 
      ...
      ('Sister of Minor Guilt', 'Промо-модель состоит из 4 частей: рюкзака, туловища, головы и оружия.

      Всего 4 файла в формате STL.
      
      Включены 2 версии файлов: с предварительной поддержкой и без поддержки. Масштабирование для столешницы 28 мм.
      
      Все части были подготовлены и протестированы для 3D-печати. Мы рекомендуем печатать на смоле.', 800, '/images/sister.jpg', '3D-Models', 2, 4, 60),
      ('Ork Big Mek', 'Мне нравится Биг Мек из компьютерной игры Dawn of war, поэтому я создал модель, основанную на этом персонаже. масштаб 28 мм. Есть много отдельных деталей - для лучшего литья. Причем самые детализированные детали вы можете распечатать на качественном дорогом принтере, а другие - на более дешевом аппарате.', 2000, '/images/ork3D.jpg', '3D-Models', 2, 2, 60);
  `);
